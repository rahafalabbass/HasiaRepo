...
// Payment Route
//Route::post('/simulate-payment',[PaymentController::class, 'createPayment'])->middleware(['auth:sanctum']);
...
Route::prefix('/subscriptions')->middleware('auth:sanctum')->group(function () {
    Route::controller(ProcessingOrdersController::class)->group(function(){
        ...
        Route::get('order-unpaid/{id?}','orderUnpaid')->middleware(['auth.employee']); // طلب عند اتمام عملية الدفع
...
//Route::post('/simulate-payment', [PaymentController::class, 'simulatePayment'])->middleware('auth:sanctum');
Route::post('/simulate-payment', [paidController::class, 'simulatePayment'])->middleware('auth:sanctum');

// createArea
Route::post('/createArea',[AreaController::class,'createArea'])->middleware(['auth:sanctum','auth.employee']);

// showEarth
Route::get('/areas', [AreaController::class, 'showEarthArea'])->middleware(['auth:sanctum','auth.employee']);